    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Get.GetX<HistoryController>(
          ...
          builder: (history) {
            return history.listHistory.isEmpty
                ? Center(
                                  ...
                                  children: [
                                    IconButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          final corpo = history
                                              .listHistory[index].descricao;
                                          final id =
                                              history.listHistory[index].id;
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          history
              .clearHistory(); // funçao de limpar os dados antes de adicionar uma nova historia
